      ...
      <div className={styles.mention}>
        <div className={styles.opening}>
          ...
          <li className={styles.mentList}>
            안녕하세요 앤즈학원입니다. {name.slice(1,3)}(이) (과목) 가르치고있는 {userName}선생님이라고
            합니다.
          </li>
          <li className={styles.mentList}>
            요즘 {name.slice(1,3)}(이)가 학원에서 어떻게 공부하고 있는지 궁금 해 하실 것 같아
            전화드렸습니다.
          </li>
        ...
        <div className={styles.content}>
          ...
          <li className={styles.mentList}>
            요즘 {name.slice(1,3)}(이)는 혹시 학원다니기 어떻다고 집에서 이야기하는 부분들이
            있나요?
          </li>
